  ...
  return (
    <StyledSalesChart>
      ...
      <Tooltip contentStyle={{backgroundColor:colors.background}}/>
        <Area name="Total sales" unit='$' strokeWidth={2} dataKey="totalSales" type='monotone' stroke={colors.totalSales.stroke} fill={colors.totalSales.fill} />
        <Area name="extras Sales" unit='$' strokeWidth={2} dataKey="extrasSales" type='monotone' stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} />
      </AreaChart>
      </ResponsiveContainer>
    </StyledSalesChart>
  )
